...
# collisions to speed up play
collision_counter = 1

# ball animation
def ball_animation():
    global ball_speed_x, ball_speed_y, scoreA, scoreB, collision_counter
    # ball delta
    ball.x += ball_speed_x
    ball.y += ball_speed_y
    ...
    if ball.top <= 0 or ball.bottom >= screen_height:
        ball_speed_y *= -(1+collision_counter)
    if ball.colliderect(player) or ball.colliderect(opponent):
        ball_speed_x *= -(1+collision_counter)
