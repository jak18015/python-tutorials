...
# text
textfont = pygame.freetype.SysFont()
...
while True:
    ...
    #scorer
    textTBD = textfont.render("Hello World!", 1, 'white', None)
    screen.blit(textTBD,(screen_width/2-textTBD.width,100))
